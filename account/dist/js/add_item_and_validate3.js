      ...
      $(document).ready(function(){
        ...
        $('#submit').click(function(){
          ...
          if($('#expense').val() == '')
          {
            error_expense = 'the store is required';
          ...
          if(error_product != '' || error_price != '' || error_qauntity != '' || error_store_id != ''  || error_description != '' )
            ...
            return false;
              ...
              $('.inner').append(`
                      <tr class="tr-products">
                         <td class="id-column"> <input name="id[]" class="form-control" type="text" value="` + $('#id').val() + `"  readonly > </td>
                         ...
                         <td class="quantity_minimum-column"> <input name="quantity_minimum[]" class="form-control" type="hidden" value="` + $('#quantity_minimum').val() + `"  readonly > </td>
