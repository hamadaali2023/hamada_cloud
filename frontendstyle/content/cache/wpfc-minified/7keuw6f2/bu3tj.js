...
$('.menu-area li.dropdown').append('<i class="fa fa-angle-down"></i>');
$('.menu-area li.dropdown .fa-angle-down').on('click', function(){
...
$(".translate-widget-form #inputSide #inputText").css("margin-top", "5px");
$(".translate-widget-form #outputSide #outputTextEntry").css("margin-top", "5px");
$(".translate-widget-form .styled-select.slate select").css("padding-left", "10px");
}}
$(function (){
...
$this.removeClass(o.css.buttonHover);
}else{
