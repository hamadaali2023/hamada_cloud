                  ...
                  <form role="form" method="post" action="{{ request()->url() }}" enctype="multipart/form-data">
                      ...
                      <div class="box-body">
                          <div class="form-group">
                           ...
                           <div class="form-group">
                            <img src="{{url($edit->image1) }}" height="60" width="70"><br>
                            <label for="exampleInputEmail1"> Choose image </label>                            
                            <input type="file" name="image1"  class="form-control" id="exampleInputEmail1" placeholder="Enter ">
                            <input type="hidden"  name="url1" value="{{$edit->image1 }}">
                          </div>                          
