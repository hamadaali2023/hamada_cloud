        ...
        <div class="col-md-12">
                    <div class="box box-primary">
                     ...
                     <p class="text-warning">
                      ...
                      <form role="form" method="post" action="{{ url('admin/min_services_add/'.$id->id.'/store') }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                          <div class="box-body">
                              ...
                              <div class="form-group">
                                   ...
                                   <input type="file" name="image1" class="form-control" id="exampleInputEmail1" placeholder="Enter "  required="" oninvalid="this.setCustomValidity('Please Enter image')" oninput="setCustomValidity('')">
                              </div>
          ...
          <div class="box">
            ...
            <div class="box-body">
               <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  @foreach ($min_services as $min_services)
                     @if(!isset($min_services->deleted_at))
                      <tr>
                        <td>{{ $min_services->id }}</td>
                        <td>{{ $min_services->title }}</td>
                        <td>{{ substr(strip_tags($min_services->description), 0, 160) }}</td>                    
                        <td><img src="{{url($min_services->image1) }}" height="50" width="50"></td>                                     
                       
                        <td><a href="{{ url('admin/min_services/'.$min_services->id.'/edit') }}"><i class="fa fa-edit"></i></a></td>
                        <td><a href="{{ url('admin/min_services/'.$min_services->id.'/delete') }}"  onclick="return confirm('Are you sure you want to delete ?')"><i class="fa fa-trash" aria-hidden="true"></i></a>
                        </td>
                       </tr>
                  	  @endif
                    @endforeach
