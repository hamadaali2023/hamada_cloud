                      ...
                      <form role="form" method="post" action="{{ url('admin/feature_add/'.$id->id.'/store') }}" enctype="multipart/form-data">
                          ...
                          <div class="box-body">
                              <div class="form-group">
                                   ...
                                   <input type="text" name="title" class="form-control" id="exampleInputEmail1" placeholder="Enter title" required="" oninvalid="this.setCustomValidity('Please Enter Description')" oninput="setCustomValidity('')">
                              </div>
                                 <div class="form-group">
