...
@endsection()
  ...
  <div class="content-wrapper">
    ...
    <script>
     ...
     <h3 class="col-xs-12"> Details  <button style="margin:10px;" id="cat" type="submit" class="btn btn-primary"> Add New  </button></h1>
        ...
        <div class="col-md-12">
                    <div class="box box-primary">
                     <p class="text-warning">
                      ...
                      <form role="form" method="post" action="{{ url('admin/details_add') }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                          <div class="box-body">
                             ...
                             <div class="form-group">
                                   <label for="exampleInputEmail1"> Chack </label>         
                  ...
                  @foreach ($details as $detail)                   
                      <tr>
                        ...
                        <td class="col-md-1 col-sm-2">
                          <a href="{{ url('admin/details/'.$detail->id.'/edit') }}"><i class="fa fa-edit"></i></a>
                        </td> 
                        <td><a href="{{ url('admin/details/'.$detail->id.'/delete') }}"  onclick="return confirm('Are you sure you want to delete ?')"><i class="fa fa-trash" aria-hidden="true"></i></a>
                        </td>                 
                      </tr>
                    @endforeach                  
                </tbody>
